...
export const ContextSwitcher: React.FC = () => {
  ...
  const IconComponent = GROUP_TYPE_ICONS[activeContext.type as keyof typeof GROUP_TYPE_ICONS] || Building2;
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-56" align="start">
        ...
        {userContexts.map((context) => {
          const ContextIcon = GROUP_TYPE_ICONS[context.group_type as keyof typeof GROUP_TYPE_ICONS] || Building2;
